...
# SWEEP_OUTPUT=$(wandb sweep --project sweep-sltrain scripts/sweep/sweep_60m_sltrain.yaml 2>&1)
...
# wandb agent weiquan0128-university-of-minnesota/sweep-sltrain/$SWEEP_ID

# wandb sweep --project sweep-sltrain sweep_60m_sltrain.yaml
wandb agent --count 1 weiquan0128-university-of-minnesota/sweep-sltrain/d89biuti