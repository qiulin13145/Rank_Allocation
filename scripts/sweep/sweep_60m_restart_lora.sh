...
# SWEEP_OUTPUT=$(wandb sweep --project sweep-sltrain scripts/sweep/sweep_60m_restart_lora.yaml 2>&1)
...
# wandb agent weiquan0128-university-of-minnesota/sweep-restart_lora/$SWEEP_ID

# wandb sweep --project sweep-restart_lora sweep_60m_restart_lora.yaml
wandb agent --count 1 weiquan0128-university-of-minnesota/sweep-restart_lora/d89biuti