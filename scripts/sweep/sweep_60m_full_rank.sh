...
# SWEEP_OUTPUT=$(wandb sweep --project sweep-full-rank scripts/sweep/sweep_60m_full_rank.yaml 2>&1)
...
# wandb agent weiquan0128-university-of-minnesota/sweep-full-rank/$SWEEP_ID

# wandb sweep --project sweep-full-rank-60m sweep_60m_full_rank.yaml
wandb agent --count 1 weiquan0128-university-of-minnesota/sweep-full-rank-60m/cs4cx9r8
