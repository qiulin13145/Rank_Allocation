...
torchrun --standalone --nproc_per_node 1 torchrun_main_DDP.py \
    --model_name sltrain-restart_plus_fira\
...
# --restart_warmup_steps 10 \  HAS NO EFFECT !!!

#  --restart_warmup_steps 10 \ ???

##   --continue_from /users/3/glent007/workspace/pretrain/parameter_efficient_pretraining/checkpoints/llama_60m-2025-02-07-18-18-31/model_100 \
