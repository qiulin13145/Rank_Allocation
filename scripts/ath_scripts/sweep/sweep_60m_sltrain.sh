...
cd /users/3/glent007/workspace/pretrain/fsdp_parameter_efficient_pretraining || exit

# wandb sweep --project sweep-sltrain sweep_60m_sltrain.yaml
wandb agent --count 8 athglentis-university-of-minnesota/benchmark/6qwpepk4 #$SWEEP_ID