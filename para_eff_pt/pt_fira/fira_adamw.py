...
class Fira_AdamW(Optimizer):
    ...
    def __init__(
        ...
        print("FIRA disable_nl = ", self.disable_nl )
            ...
            for p in group["params"]:
                ...
                if "rank" in group:
                    if "projector" not in state:
                        state["projector"] = GradientProjector(group["rank"], update_proj_gap=group["update_proj_gap"], alpha=group["scale"], proj_type=group["proj_type"])
