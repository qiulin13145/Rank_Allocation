...
## ???? is this the same as moonlight's muon ??? this is from our github repo ...
...
class Moonlight_Muon(torch.optim.Optimizer):
    ...
    def __init__(self, muon_params, lr=0.02, momentum=0.95, nesterov=True, ns_steps=6,
                 adamw_params=None, adamw_lr=3e-4, adamw_betas=(0.9, 0.98), adamw_eps=1e-8, adamw_wd=0):
    ...
    def step(self, closure=None, step_for_warmup=None):
        ...
        for group in self.param_groups:
            ...
            if step_for_warmup is not None:
                frac = min(step_for_warmup / 300, 1)
